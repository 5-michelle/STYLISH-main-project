...
describe('products', async () => {
    it('select all products without setting page', async () => {
        const res = await requester.get('/api/1.0/products/all');
    ...
    it('select all products at page 2', async () => {
        const res = await requester.get('/api/1.0/products/all?paging=2');
    ...
    it('select products with wrong parameter', async () => {
        // men
        const res = await requester.get('/api/1.0/products/wrong_parameter');
    ...
    it('select products with category', async () => {
        // men
        const res1 = await requester.get('/api/1.0/products/men');
        ...
        // men page 1
        const res2 = await requester.get('/api/1.0/products/men?paging=1');
        ...
        // women
        const res3 = await requester.get('/api/1.0/products/women');
        ...
        // accessories
        const res4 = await requester.get('/api/1.0/products/accessories');
    ...
    it('select products with search key', async () => {
        const res = await requester.get('/api/1.0/products/search?keyword=searchkey');
    ...
    it('select products with search key which have no data', async () => {
        const res = await requester.get('/api/1.0/products/search?keyword=nodatakey');
    ...
    it('select product detail', async () => {
        const res = await requester.get('/api/1.0/products/details?id=1');
    ...
    it('select product detail with id which can not find data', async () => {
        const res = await requester.get('/api/1.0/products/details?id=0');
    ...
    it('select product detail with id which is not integer', async () => {
        const res = await requester.get('/api/1.0/products/details?id=aaa');
